...
const ExpandedProduct = ({data, handleAction}) => {
	return (
		<>
			<div className={`table__container ${styles.product_systems}`}>
				<table className='table'>
					...
					<tbody>
						...
						<tr>
							<td>Estado</td>
							<td data-titulo='ML'>{data.prodMl?.status}</td>
							<td data-titulo='Local'>{data.status}</td>
							<td data-titulo='Web'>{data.prodWeb?.status}</td>
						</tr>
						<tr>
							<td>Cantidad</td>
